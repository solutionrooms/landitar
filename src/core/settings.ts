...
export const SETTING_DEFS: SettingDef[] = [
  ...
  { key: 'fuelThrustRate',   label: 'Thrust Fuel Rate',    min: 0,    max: 50,    step: 2, format: v => v + '/s' },
  { key: 'fuelShootRate',    label: 'Shoot Fuel Cost',     min: 0,    max: 30,    step: 1, format: v => String(v) },
